...
public class Itemset {
	 ...
	 * @param efficiency the utility of the itemset
	 */
	public Itemset(List<Integer> itemset, double efficiency){
	 ...
	 * @param efficiency
	 */
	public Itemset(int[] itemset, double efficiency){
	...
	/**
	 * Set the efficiency of this itemset
	 * @param efficiency the utility
	 */
